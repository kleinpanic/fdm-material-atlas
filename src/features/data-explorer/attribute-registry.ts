...
function endpointFact(
  fact: FactState<
    | { readonly shape: "exact"; readonly value: number; readonly unit: "degC" }
    | { readonly shape: "range"; readonly min: number; readonly max: number; readonly unit: "degC" }
  >,
  endpoint: "low" | "high",
): FactState<number> {
  switch (fact.state) {
    case "known":
      return {
        state: "known",
        value:
          fact.value.shape === "exact"
            ? fact.value.value
            : fact.value[endpoint === "low" ? "min" : "max"],
      };
    case "conditional": {
    ...
    case "unknown":
      return { state: "unknown", reason: fact.reason };
    case "not-applicable":
      return fact.reason === undefined
        ? { state: "not-applicable" }
        : { state: "not-applicable", reason: fact.reason };
    case "missing":
      return { state: "missing", reason: fact.reason };
  }
}
...
function thermalDescriptor(
  ...
  const observations = (material: Material): readonly ThermalObservation[] =>
  ...
  return {
    ...
    caution:
      "Values from unlike thermal metrics or represented methods are not directly interchangeable.",
...
export const DATA_ATTRIBUTE_REGISTRY = Object.freeze([
  ...
  claimDescriptor(
    ...
    1,
    (m) => m.familyOrFill,
    { sort: "label", help: "Polymer family or represented filler identity." },
  ),
  ...
  claimDescriptor(
    ...
    "mechanical-use",
    6,
    (m) => m.properties.wearAbrasion,
    { sort: "vocabulary", help: "Qualitative wear and abrasion behavior." },
  ),
  claimDescriptor(
    "impact-resistance",
    "Impact resistance",
    "mechanical-use",
    7,
    (m) => m.properties.impactResistance,
    { sort: "vocabulary", help: "Qualitative impact-resistance behavior." },
  ),
  claimDescriptor(
    ...
    "mechanical-use",
    8,
    (m) => m.properties.creepSustainedLoad,
    { sort: "vocabulary", help: "Qualitative behavior under sustained loading." },
  ),
  claimDescriptor(
    "flexibility",
    "Flexibility",
    "mechanical-use",
    9,
    (m) => m.properties.flexibility,
    { sort: "vocabulary", help: "Qualitative flexibility classification." },
  ),
  claimDescriptor(
    "outdoor-uv",
    ...
    10,
    (m) => m.properties.outdoorUv,
    { sort: "vocabulary", help: "Qualitative outdoor and ultraviolet exposure guidance." },
  ),
  claimDescriptor(
    ...
    "environment-exposure",
    11,
    (m) => m.properties.moistureSensitivity,
    { sort: "vocabulary", help: "Qualitative sensitivity to absorbed moisture." },
  ),
  claimDescriptor(
    "chemical-resistance",
    "Chemical resistance",
    "environment-exposure",
    12,
    (m) => m.properties.chemicalResistance,
    {
      sort: "vocabulary",
      help: "Qualitative chemical-resistance guidance; verify the specific chemical and formulation.",
    },
  ),
  claimDescriptor(
    "print-difficulty",
    ...
    "print-process",
    13,
    (m) => m.process.printDifficulty,
    { sort: "vocabulary", help: "Relative printing difficulty in the documented process context." },
  ),
  claimDescriptor(
    "nozzle-temperature",
    "Nozzle temperature",
    "print-process",
    14,
    (m) => m.process.nozzleTemperature,
    { sort: "number", help: "Nozzle-temperature starting guidance." },
  ),
  claimDescriptor(
    "bed-temperature",
    "Bed temperature",
    "print-process",
    15,
    (m) => m.process.bedTemperature,
    { sort: "number", help: "Build-surface temperature starting guidance." },
  ),
  claimDescriptor(
    ...
    "print-process",
    16,
    (m) => m.process.enclosure,
    { sort: "vocabulary", help: "Documented enclosure process requirement." },
  ),
  claimDescriptor(
    ...
    "print-process",
    17,
    (m) => m.process.hardenedNozzle,
    { sort: "vocabulary", help: "Whether a wear-resistant nozzle is recommended or required." },
  ),
  claimDescriptor(
    "warp-tendency",
    "Warp tendency",
    "print-process",
    18,
    (m) => m.properties.warpTendency,
    { sort: "vocabulary", help: "Qualitative tendency to warp during printing and cooling." },
  ),
  claimDescriptor(
    "cooling-shrink-risk",
    "Cooling-shrink risk",
    "dimensional-cooling",
    19,
    (m) => m.properties.coolingShrinkRisk,
    { sort: "vocabulary", help: "Qualitative cooling and shrink risk." },
  ),
  claimDescriptor(
    ...
    "dimensional-cooling",
    20,
    (m) => m.properties.dimensionalStability,
    { sort: "vocabulary", help: "Qualitative dimensional-stability guidance." },
  ),
  claimDescriptor(
    "cooling-fit-guidance",
    "Cooling and fit guidance",
    "dimensional-cooling",
    21,
    (m) => m.guidance.coolingFit,
    { sort: "vocabulary", help: "Cooling approach and fit-calibration guidance." },
  ),
  claimDescriptor(
    "drying-priority",
    "Drying priority",
    ...
    22,
    (m) => m.process.dryingPriority,
    { sort: "vocabulary", help: "Relative priority of drying before or during printing." },
  ),
  claimDescriptor(
    ...
    "handling-density-cost",
    23,
    (m) => m.process.ventilation,
    { sort: "vocabulary", help: "Ventilation or odor-control process category." },
  ),
  claimDescriptor("density", "Density", "handling-density-cost", 24, (m) => m.properties.density, {
    sort: "number",
    help: "Reported material density with units and evidence scope.",
  }),
  claimDescriptor(
    "relative-cost-tier",
    "Relative cost tier",
    ...
    25,
    (m) => m.costTier,
    { sort: "vocabulary", help: "Relative qualitative cost tier, not a live price." },
  ),
  claimDescriptor(
    "recommended-uses",
    "Recommended uses",
    "uses-tradeoffs",
    26,
    (m) => m.guidance.bestSuitedFor,
    { sort: "label", help: "Complete source-order list of recommended applications." },
  ),
  claimDescriptor("tradeoffs", "Tradeoffs", "uses-tradeoffs", 27, (m) => m.guidance.tradeoffs, {
    sort: "label",
    help: "Complete source-order list of material tradeoffs.",
  }),
  claimDescriptor(
    ...
    "starting-profile",
    28,
    (m) => m.startingProfile.printSpeed,
    { sort: "number", help: "Calibration starting point for print speed." },
  ),
  claimDescriptor(
    "part-cooling-fan",
    "Part-cooling fan",
    "starting-profile",
    29,
    (m) => m.startingProfile.partCoolingFan,
    { sort: "number", help: "Calibration starting point for part-cooling fan." },
  ),
  claimDescriptor(
    "bridge-speed",
    "Bridge speed",
    "starting-profile",
    30,
    (m) => m.startingProfile.bridgeSpeed,
    { sort: "number", help: "Calibration starting point for bridge speed." },
  ),
  claimDescriptor(
    "bridge-fan",
    "Bridge fan",
    "starting-profile",
    31,
    (m) => m.startingProfile.bridgeFan,
    { sort: "number", help: "Calibration starting point for bridge fan." },
  ),
...
export const DATA_ATTRIBUTE_GROUPS = Object.freeze(
