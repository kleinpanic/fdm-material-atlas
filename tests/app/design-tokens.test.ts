...
const TEST_ONLY_EXACT_TOKEN_ORACLE = {
  ...
  "--color-page": "#0B1117",
  "--color-surface": "#131D26",
  "--color-ink-strong": "#F4F7F9",
  "--color-ink": "#D8E1E8",
  "--color-ink-muted": "#AAB7C2",
  "--color-rule": "#40515F",
  "--color-surface-subtle": "#1B2935",
  "--color-accent": "#FFB000",
  "--color-destructive": "#FF6B6B",
  "--color-focus": "#22D3EE",
  "--color-hover": "#2B3945",
  "--color-disabled-ink": "#8B9AA6",
  "--color-disabled-surface": "#202C36",
  "--color-caution-information": "#5BC0EB",
  "--color-caution-verify": "#FFD166",
  "--color-caution-incompatible": "#FF6B6B",
  "--color-caution-unknown": "#AAB7C2",
  "--color-caution-not-applicable": "#AAB7C2",
  "--color-family-neutral": "#AAB7C2",
  "--color-thermal-service": "#2DD4BF",
  "--color-thermal-tg": "#C4A7FF",
  "--color-thermal-hdt": "#FF9F43",
  "--color-thermal-vicat": "#FFD166",
  "--color-thermal-melting": "#FF6B4A",
  "--color-thermal-other": "#AAB7C2",
  "--color-gate-available": "#4ADE80",
  "--color-gate-verify": "#FFD166",
  "--color-gate-blocked": "#FF6B6B",
  "--color-gate-unknown": "#AAB7C2",
  "--color-gate-not-applicable": "#AAB7C2",
