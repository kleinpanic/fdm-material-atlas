...
describe("material reference component contract", () => {
  ...
  it("uses one native repeated-field form for canonical two-material comparison", () => {
    ...
    expect(source).toContain(
      'type="hidden" name="material" value={model.continuity.currentMaterialId}',
    );
    ...
    expect(source.indexOf('type="hidden" name="material"')).toBeLessThan(
      source.indexOf('name="material" required'),
    );
  });
